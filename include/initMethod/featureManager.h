...
using FeatureTrackerResulst =
    Eigen::aligned_map<int, Eigen::aligned_vector<std::pair<int, Eigen::Matrix<double, 7, 1>>>>;
...
class SFMFeature {
 public:
  ...
  SFMFeature(FeatureID _feature_id, TimeFrameId _start_frame) : feature_id(_feature_id), kf_id(_start_frame) {}

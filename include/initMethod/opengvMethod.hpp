...
static Eigen::Matrix3d ComposeMwithJacobians(const Eigen::Matrix3d &xxF,
...
template <typename T>
static Eigen::Matrix<T, 3, 3> ComposeMwithJacobians(const Eigen::Matrix3d &xxF,
                                                    const Eigen::Matrix3d &yyF,
                                                    const Eigen::Matrix3d &zzF,
                                                    const Eigen::Matrix3d &xyF,
                                                    const Eigen::Matrix3d &yzF,
...
static double GetSmallestEVwithJacobian(const Eigen::Matrix3d &xxF,
                                        const Eigen::Matrix3d &yyF,
                                        const Eigen::Matrix3d &zzF,
                                        const Eigen::Matrix3d &xyF,
                                        const Eigen::Matrix3d &yzF,
  ...
  Eigen::Matrix3d M = ComposeMwithJacobians(xxF, yyF, zzF, xyF, yzF, zxF, cayley, M_jac1, M_jac2, M_jac3);
  ...
  double d_jac1 =
      M_jac1(1, 1) * pow(M(0, 2), 2) + M(1, 1) * 2 * M(0, 2) * M_jac1(0, 2) + M_jac1(0, 0) * pow(M(1, 2), 2) +
  ...
  double d_jac2 =
      M_jac2(1, 1) * pow(M(0, 2), 2) + M(1, 1) * 2 * M(0, 2) * M_jac2(0, 2) + M_jac2(0, 0) * pow(M(1, 2), 2) +
  ...
  double d_jac3 =
      M_jac3(1, 1) * pow(M(0, 2), 2) + M(1, 1) * 2 * M(0, 2) * M_jac3(0, 2) + M_jac3(0, 0) * pow(M(1, 2), 2) +
...
template <typename T>
static T GetSmallestEVwithJacobian(const Eigen::Matrix3d &xxF,
                                   const Eigen::Matrix3d &yyF,
                                   const Eigen::Matrix3d &zzF,
                                   const Eigen::Matrix3d &xyF,
                                   const Eigen::Matrix3d &yzF,
  ...
  Matrix3T M = ComposeMwithJacobians(xxF, yyF, zzF, xyF, yzF, zxF, cayley, M_jac1, M_jac2, M_jac3);
  ...
  T c = -ceres::pow(M(0, 2), 2) - ceres::pow(M(1, 2), 2) - ceres::pow(M(0, 1), 2) + M(0, 0) * M(1, 1) +
        M(0, 0) * M(2, 2) + M(1, 1) * M(2, 2);
  T c_jac1 = -2.0 * M(0, 2) * M_jac1(0, 2) - T(2.0) * M(1, 2) * M_jac1(1, 2) - 2.0 * M(0, 1) * M_jac1(0, 1) +
             M_jac1(0, 0) * M(1, 1) + M(0, 0) * M_jac1(1, 1) + M_jac1(0, 0) * M(2, 2) + M(0, 0) * M_jac1(2, 2) +
             M_jac1(1, 1) * M(2, 2) + M(1, 1) * M_jac1(2, 2);
  T c_jac2 = -2.0 * M(0, 2) * M_jac2(0, 2) - T(2.0) * M(1, 2) * M_jac2(1, 2) - 2.0 * M(0, 1) * M_jac2(0, 1) +
             M_jac2(0, 0) * M(1, 1) + M(0, 0) * M_jac2(1, 1) + M_jac2(0, 0) * M(2, 2) + M(0, 0) * M_jac2(2, 2) +
             M_jac2(1, 1) * M(2, 2) + M(1, 1) * M_jac2(2, 2);
  T c_jac3 = -2.0 * M(0, 2) * M_jac3(0, 2) - T(2.0) * M(1, 2) * M_jac3(1, 2) - 2.0 * M(0, 1) * M_jac3(0, 1) +
             M_jac3(0, 0) * M(1, 1) + M(0, 0) * M_jac3(1, 1) + M_jac3(0, 0) * M(2, 2) + M(0, 0) * M_jac3(2, 2) +
             M_jac3(1, 1) * M(2, 2) + M(1, 1) * M_jac3(2, 2);
  T d = M(1, 1) * ceres::pow(M(0, 2), 2) + M(0, 0) * ceres::pow(M(1, 2), 2) + M(2, 2) * ceres::pow(M(0, 1), 2) -
  ...
  T d_jac1 =
      ...
      M_jac1(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac1(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac1(2, 2) -
      T(2.0) * (M_jac1(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac1(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac1(0, 2));
  T d_jac2 =
      ...
      M_jac2(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac2(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac2(2, 2) -
      T(2.0) * (M_jac2(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac2(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac2(0, 2));
  T d_jac3 =
      ...
      M_jac3(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac3(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac3(2, 2) -
      T(2.0) * (M_jac3(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac3(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac3(0, 2));
  ...
  T alpha_jac1 = T(-1.0) / ceres::sqrt(T(1.0) - (ceres::pow(s, 2) / t)) *
                 (s_jac1 * ceres::sqrt(t) - s * T(0.5) * ceres::pow(t, -0.5) * t_jac1) / t;
  T alpha_jac2 = T(-1.0) / ceres::sqrt(T(1.0) - (ceres::pow(s, 2) / t)) *
                 (s_jac2 * ceres::sqrt(t) - s * T(0.5) * ceres::pow(t, -0.5) * t_jac2) / t;
  T alpha_jac3 = T(-1.0) / ceres::sqrt(T(1.0) - (ceres::pow(s, 2) / t)) *
...
static Eigen::Matrix3d ComposeM(const Eigen::Matrix3d &xxF,
                                const Eigen::Matrix3d &yyF,
                                const Eigen::Matrix3d &zzF,
                                const Eigen::Matrix3d &xyF,
                                const Eigen::Matrix3d &yzF,
